      ...
      <g id="dongxiao1">
        ...
        <g id="right">
          <g id="组_380" data-name="组 380">
            ...
            <!-- 生成小点 -->
            <template v-for="item in [3, 2, 1]" :key="item">
              <!-- blue -->
              <circle :id="`cy-circle-${item}`" class="cus-cls-blue" cx="0" cy="0" r="3" fill="#fff">
              </circle>
              <animateMotion
                :href="`#cy-circle-${item}`"
                rotate="auto"
              ...
              <circle :id="`cy-circle-${item * 10}`" class="cus-cls-blue" cx="0" cy="0" r="3" fill="#fff">
              </circle>
              <animateMotion
                :href="`#cy-circle-${item * 10}`"
                rotate="auto"
                dur="5s"
                begin="-3s"
                repeatCount="indefinite"
              ...
              <!-- orange -->
              <circle :id="`cy-circle-o-${item}`" class="cus-cls-orange" cx="0" cy="0" r="3" fill="#fff">
              </circle>
              <animateMotion
                :href="`#cy-circle-o-${item}`"
                rotate="auto"
                dur="5s"
                begin="-1s"
                repeatCount="indefinite"
              ...
              <circle :id="`cy-circle-o-${item * 10}`" class="cus-cls-orange" cx="0" cy="0" r="3" fill="#fff">
              </circle>
              <animateMotion
                :href="`#cy-circle-o-${item * 10}`"
                rotate="auto"
                dur="5s"
                begin="-3s"
                repeatCount="indefinite"
...
onMounted(() => {
  ...
  //   duration: 1,
  // })
  // gsap.from(['#center-house'], {
  //   y: 80,
  //   duration: 1
  // })

  timeline.from(['#dongxiao'], {
    scale: 0.7,
    duration: 1,
  }).from(['#center-house'], {
    y: 80,
